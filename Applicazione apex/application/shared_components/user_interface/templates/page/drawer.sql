...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(10416592518221098)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10416805163221110)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10417157047221112)
,p_page_template_id=>wwv_flow_imp.id(10416592518221098)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10417497311221112)
,p_page_template_id=>wwv_flow_imp.id(10416592518221098)
