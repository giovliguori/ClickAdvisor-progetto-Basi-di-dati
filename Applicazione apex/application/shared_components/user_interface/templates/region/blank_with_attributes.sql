...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10452443720221185)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10452774950221187)
,p_plug_template_id=>wwv_flow_imp.id(10452443720221185)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10453034133221187)
,p_plug_template_id=>wwv_flow_imp.id(10452443720221185)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10453392241221187)
,p_plug_template_id=>wwv_flow_imp.id(10452443720221185)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10453601360221187)
,p_plug_template_id=>wwv_flow_imp.id(10452443720221185)
,p_name=>'Sub Regions'
