...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10453809613221187)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10454100674221189)
,p_plug_template_id=>wwv_flow_imp.id(10453809613221187)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10454495288221189)
,p_plug_template_id=>wwv_flow_imp.id(10453809613221187)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10454704369221189)
,p_plug_template_id=>wwv_flow_imp.id(10453809613221187)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10455036135221190)
,p_plug_template_id=>wwv_flow_imp.id(10453809613221187)
,p_name=>'Sub Regions'
