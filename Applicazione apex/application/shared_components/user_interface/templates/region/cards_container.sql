...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10459597811221196)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10459851570221196)
,p_plug_template_id=>wwv_flow_imp.id(10459597811221196)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10460122352221196)
,p_plug_template_id=>wwv_flow_imp.id(10459597811221196)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10460466313221198)
,p_plug_template_id=>wwv_flow_imp.id(10459597811221196)
,p_name=>'Sub Regions'
