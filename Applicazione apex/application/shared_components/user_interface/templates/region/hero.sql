...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10485445271221234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10485754196221235)
,p_plug_template_id=>wwv_flow_imp.id(10485445271221234)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10486046233221235)
,p_plug_template_id=>wwv_flow_imp.id(10485445271221234)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10486305423221235)
,p_plug_template_id=>wwv_flow_imp.id(10485445271221234)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10486695452221237)
,p_plug_template_id=>wwv_flow_imp.id(10485445271221234)
,p_name=>'Sub Regions'
