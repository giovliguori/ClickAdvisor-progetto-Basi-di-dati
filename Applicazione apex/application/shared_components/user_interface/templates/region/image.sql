...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10488682144221240)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10488993677221243)
,p_plug_template_id=>wwv_flow_imp.id(10488682144221240)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10489283727221243)
,p_plug_template_id=>wwv_flow_imp.id(10488682144221240)
,p_name=>'Sub Regions'
