...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10508671309221279)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10508953396221279)
,p_plug_template_id=>wwv_flow_imp.id(10508671309221279)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10509271629221281)
,p_plug_template_id=>wwv_flow_imp.id(10508671309221279)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10509578022221281)
,p_plug_template_id=>wwv_flow_imp.id(10508671309221279)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10509860555221281)
,p_plug_template_id=>wwv_flow_imp.id(10508671309221279)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10510133435221282)
,p_plug_template_id=>wwv_flow_imp.id(10508671309221279)
,p_name=>'Sub Regions'
