...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10510733907221282)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10511012702221284)
,p_plug_template_id=>wwv_flow_imp.id(10510733907221282)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10511352366221284)
,p_plug_template_id=>wwv_flow_imp.id(10510733907221282)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10511631716221284)
,p_plug_template_id=>wwv_flow_imp.id(10510733907221282)
,p_name=>'Button Start'
