...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10513250035221287)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10513544164221289)
,p_plug_template_id=>wwv_flow_imp.id(10513250035221287)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10513813660221289)
,p_plug_template_id=>wwv_flow_imp.id(10513250035221287)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10514106151221289)
,p_plug_template_id=>wwv_flow_imp.id(10513250035221287)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10514477227221290)
,p_plug_template_id=>wwv_flow_imp.id(10513250035221287)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10514770687221290)
,p_plug_template_id=>wwv_flow_imp.id(10513250035221287)
,p_name=>'Sub Regions'
