...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10515713522221292)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10516012659221292)
,p_plug_template_id=>wwv_flow_imp.id(10515713522221292)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10516325367221293)
,p_plug_template_id=>wwv_flow_imp.id(10515713522221292)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10516624364221293)
,p_plug_template_id=>wwv_flow_imp.id(10515713522221292)
,p_name=>'Sub Regions'
