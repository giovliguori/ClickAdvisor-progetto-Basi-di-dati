...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10528288128221312)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10528569801221312)
,p_plug_template_id=>wwv_flow_imp.id(10528288128221312)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10528809058221312)
,p_plug_template_id=>wwv_flow_imp.id(10528288128221312)
,p_name=>'Tabs'
