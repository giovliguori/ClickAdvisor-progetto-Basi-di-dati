...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10535692607221325)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10535952048221326)
,p_plug_template_id=>wwv_flow_imp.id(10535692607221325)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10536279390221326)
,p_plug_template_id=>wwv_flow_imp.id(10535692607221325)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10536561690221326)
,p_plug_template_id=>wwv_flow_imp.id(10535692607221325)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10536819935221326)
,p_plug_template_id=>wwv_flow_imp.id(10535692607221325)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10537117621221328)
,p_plug_template_id=>wwv_flow_imp.id(10535692607221325)
